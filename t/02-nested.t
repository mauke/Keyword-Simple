...

{
  ...
  sub import {
    Keyword::Simple::define for_digit => sub {
      my($ref)=@_;
      substr($$ref, 0, 0) = 'for (0..9)'; # inject greeting at beginning of parse buffer
    };    
  }

  sub unimport {
    Keyword::Simple::undefine 'for_digit';
  }
...
for_digit {
  ...
  for_digit {
    my $second = $_;
    push @multiplication_table, [$first, $second, $first * $second];
  }
}

is_deeply(\@multiplication_table,[
